...
export default function SearchInput({ text, userInput, setUserInput, type }) {

    const navigate = useNavigate();

    return (
        <div className={styles.search_input}>
            <button className={styles.search_input__button} onClick={() => { userInput ? navigate(`/search?q=${userInput}&type=${type}`) : null }}  type='button'  aria-label='Search'>
