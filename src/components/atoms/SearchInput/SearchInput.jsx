...
export default function SearchInput({ text, arraysToSearch = [] }) {
    const [userInput, setUserInput] = useState('');

    //TODO add a .normalize/sort function within a search algorithm

    return (
        <div className={styles.search_input}>
            <button className={styles.search_input__button} type='button'>
