...
export default function SearchInput({ text, fetchedItems, search, userInput, setUserInput }) {

    return (
        <div className={styles.search_input}>
            <button className={styles.search_input__button} onClick={() => { fetchedItems([]); fetchMediaAPI(fetchedItems, userInput, search) }}  type='button'  aria-label="Search">
