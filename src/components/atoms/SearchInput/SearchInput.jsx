...
export default function SearchInput({ text, userInput, setUserInput, setIsSearchButtonPressed }) {


    return (
        <div className={styles.search_input}  role='searchbox'  aria-label='search a movie or tv show'>
            <button className={styles.search_input__button} onClick={() => setIsSearchButtonPressed(true)} type='button' aria-label='Search'>
            ...
            <input
                ...
                aria-label='input your search for movie or tv show'
            />
        </div>
    )
}