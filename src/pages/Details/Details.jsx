                        ...
                        <div className={stylesDetail.media__body}>
                            ...
                            <div className={stylesDetail.media__info}>
                                <div className={stylesDetail.media__detail}>
                                    <span className={`${stylesApp.separator}  ${stylesApp['separator--bigger']}  text_preset_5  text_preset_5--bigger  text_white`}>{formatYear(mediaDetails.release_date || mediaDetails.first_air_date)}</span>
